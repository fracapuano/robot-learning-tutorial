...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/ch4/ch4-normalizing-flows.png}
    \caption{Probability distributions can be modified by applying vector fields, which induce a flow of mass across their support. Evolving over time, these fields can reshape the structure of a distribution. FM models learn to approximate a target vector field, thereby producing the desired transformation of an initial distribution.}
