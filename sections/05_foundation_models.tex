...
Crucially, because communication is obstructed between image-language tokens, proprioceptive tokens and action tokens, one can cache keys and values across denoising steps at runtime time, incuring in a reduced computational footprint and faster inference.
